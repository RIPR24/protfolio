...
const url1: string = "https://singular-hamster-33a29c.netlify.app";
...
export const arr2: imgarr[] = [
  {
    url: fdeladmin,
    str: "https://food-delivery-admin-4yyi.onrender.com",
  },
  {
    url: fdelFront,
